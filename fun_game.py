...
position = {num[0]:[0,0],num[1]:[1,0],num[2]:[2,0],num[3]:[3,0],num[4]:[4,0],
            ...
            num[10]:[0,2],num[11]:[1,2],num[12]:[2,2],num[13]:[3,2],num[14]:[3,2],
...
import random as r
def random_num():
    print(r.randint(1,75))

####replacing board with input####
def change_board():
    board[num_position[0]][num_position[1]] = 'x'
...
def check():
    ...
    if game == False:
        global user_input2
        user_input2 = input("You have bingo say BINGO! ")
...
while gameNotOver:
    ...
    if user_input == "BINGO":
        ...
        if bypass:
            ...
            if board_num == board[num_position[0]][num_position[1]]:
...
####replacing board with input#### - joey
def change_board():
    board[num_position[0]][num_position[1]] = ' x '
